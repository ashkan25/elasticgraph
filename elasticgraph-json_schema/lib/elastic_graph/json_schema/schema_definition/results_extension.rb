    ...
    module SchemaDefinition
      ...
      module ResultsExtension
        ...
        def json_schema_with_metadata_merger
          @json_schema_with_metadata_merger ||= ElasticGraph::SchemaDefinition::Indexing::JSONSchemaWithMetadata::Merger.new(self)
        end
        ...
        def build_public_json_schema
...

          {
            ...
            "$defs" => {
              "ElasticGraphEventEnvelope" => ElasticGraph::SchemaDefinition::Indexing::EventEnvelope.json_schema(root_document_type_names, json_schema_version)
